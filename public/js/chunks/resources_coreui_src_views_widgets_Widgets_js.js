(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_coreui_src_views_widgets_Widgets_js"],{
...
var CChart = (0,react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(function (props, ref) {
    ...
    var canvas = function (ref) {
        return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("canvas", __assign({}, (!wrapper && className && { className: className }), { "data-testid": "canvas", height: height, id: id, onClick: function (e) {
                handleOnClick(e);
            }, ref: ref, role: "img", width: width }, rest), fallbackContent));
    };
    return wrapper ? (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", __assign({ className: classNames('chart-wrapper', className) }, rest), canvas(canvasRef))) : (canvas(canvasRef));
});
CChart.propTypes = {
...
/* harmony import */ var _WidgetsBrand__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./WidgetsBrand */ "./resources/coreui/src/views/widgets/WidgetsBrand.js");
/* harmony import */ var _WidgetsDropdown__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./WidgetsDropdown */ "./resources/coreui/src/views/widgets/WidgetsDropdown.js");
